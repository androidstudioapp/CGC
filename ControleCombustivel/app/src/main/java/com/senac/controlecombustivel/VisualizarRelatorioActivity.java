...
public class VisualizarRelatorioActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Criando os arrays que definem onde os dados vindo da lista de Map v�o ficar.
        ...
        // Pegando do web service o relat�rio
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_relatorio:
                ...
                return true;
            // 16908332 � o id do bot�o de seta para voltar.
            case 16908332:
                super.onBackPressed();
                return true;
            default:
