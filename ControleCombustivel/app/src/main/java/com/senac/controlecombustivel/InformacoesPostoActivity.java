    ...
    public void atualizaPreco(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.bt_gasolinaOk :
                ...
                WebService.atualizarTiposCombustivel(combustiveis.get(0), idAndroid);
            ...
            case R.id.bt_etanolOk :
                ...
                WebService.atualizarTiposCombustivel(combustiveis.get(1), idAndroid);
            ...
            case R.id.bt_gnvOk :
                ...
                WebService.atualizarTiposCombustivel(combustiveis.get(2), idAndroid);
